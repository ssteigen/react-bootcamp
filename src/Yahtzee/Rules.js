...
class SmallStraight extends Rule {
  evalRoll = (dice) => {
    ...
    // [1,2,3,4]
    if (d.has(1) && d.has(2) && d.has(3) && d.has(4)) return this.score;

    // [2,3,4,5]
    if (d.has(2) && d.has(3) && d.has(4) && d.has(5)) return this.score;

    // [3,4,5,6]
    if (d.has(3) && d.has(4) && d.has(5) && d.has(6)) return this.score;
